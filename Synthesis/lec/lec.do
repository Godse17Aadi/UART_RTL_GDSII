...
read design -verilog   -golden -lastmod -noelab fv/uart_top_design/fv_map.v.gz
elaborate design -golden -root uart_top_design

read design -verilog -revised -lastmod -noelab outputs/uart_netlist.v 
elaborate design -revised -root uart_top_design
